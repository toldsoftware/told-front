...
(function (Example_Todo2) {
    ...
    function action(t, actions) {
    }
    ;
    function action2(t, actions) {
    }
    ;
    var tasksA = { addAction: function (params) { } };
    ...
    var actions = {
        ...
        completeAll_3: {
            with: function () { return tasks; },
            at: function (t) { return t.some(function (x) { return !x.complete; }); },
            do: function (t) { return t.forEach(function (x) { return x.complete = true; }); },
            pre: function (t) { return [{ complete: false }, { complete: true }]; },
            nat: function (t) { return [{ complete: true }, { complete: true }]; },
            post: function (t) { return [{ complete: true }, { complete: true }]; },
        },
        completeAll_4: action(state.tasks, function (t) { return ({
            at: function () { return t.some(function (x) { return !x.complete; }); },
            do: function () { return t.forEach(function (x) { return x.complete = true; }); },
            pre: function () { return [{ complete: false }, { complete: true }]; },
            nat: function () { return [{ complete: true }, { complete: true }]; },
            post: function () { return [{ complete: true }, { complete: true }]; },
        }); }),
        completeAll_5: tasksA.addAction(function (t) { return ({
            at: function () { return t.some(function (x) { return !x.complete; }); },
            do: function () { return t.forEach(function (x) { return x.complete = true; }); },
            pre: function () { return [{ complete: false }, { complete: true }]; },
            nat: function () { return [{ complete: true }, { complete: true }]; },
