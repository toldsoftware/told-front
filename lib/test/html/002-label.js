...
describe('empty label', function () {
    var label = src_1.TsxBuilder.createElement("label", null);
    it('should become empty span', function () {
        _0_helpers_1.expectHtml(label, '<span></span>');
    });
});
describe('label with text', function () {
    var label = src_1.TsxBuilder.createElement("label", null, "SOME TEXT");
...
describe('label with text attributes', function () {
    var label = src_1.TsxBuilder.createElement("label", { prefix: 'BEFORE ', suffix: ' AFTER' }, "SOME TEXT");
